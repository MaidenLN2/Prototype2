...
#define UE_PROJECT_NAME HauntedHotel
#define UE_TARGET_NAME HauntedHotelEditor
#define UE_MODULE_NAME "HauntedHotel"
...
#define HAUNTEDHOTEL_API DLLEXPORT
